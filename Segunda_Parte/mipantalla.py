...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.listaEmpleados.setGeometry(QtCore.QRect(300, 50, 450, 400))
    ...
    def guardar_informacion(self):
        ...
        cadena_sql = """INSERT INTO Equipos (nombre, siglas, estadio, seguidores, campeonatos) VALUES ('%s','%s','%s','%d', %d);""" % \
    ...
    def obtener_informacion(self):
        ...
        column_titles = ["Nombre", "Siglas", "Estadio", "Seguidores", "Campeonatos"]
        self.listaEmpleados.setHorizontalHeaderLabels(column_titles)
